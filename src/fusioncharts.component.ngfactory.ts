...
export class Wrapper_FusionChartsComponent {
  ...
  constructor(p0:any) {
    this._changed = false;
    this.context = new import0.FusionChartsComponent(p0);
...
class View_FusionChartsComponent_Host0 extends import2.AppView<any> {
  ...
  _FusionChartsComponent_0_3:Wrapper_FusionChartsComponent;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_FusionChartsComponent_Host0,renderType_FusionChartsComponent_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._FusionChartsComponent_0_3 = new Wrapper_FusionChartsComponent(new import9.ElementRef(this._el_0));
    this.compView_0.create(this._FusionChartsComponent_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._FusionChartsComponent_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.FusionChartsComponent) && (0 === requestNodeIndex))) { return this._FusionChartsComponent_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this._FusionChartsComponent_0_3.ngDoCheck(this,this._el_0,throwOnChange);
    this.compView_0.internalDetectChanges(throwOnChange);
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._FusionChartsComponent_0_3.context.ngAfterViewInit(); } }
  }
...
export const FusionChartsComponentNgFactory:import8.ComponentFactory<import0.FusionChartsComponent> = new import8.ComponentFactory<import0.FusionChartsComponent>('fusioncharts',View_FusionChartsComponent_Host0,import0.FusionChartsComponent);
...
export class View_FusionChartsComponent0 extends import2.AppView<import0.FusionChartsComponent> {
  ...
  _text_1:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_FusionChartsComponent0,renderType_FusionChartsComponent,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
